...
Этот документ сохраняет границы более раннего pilot package на baseline `3396058`. Это историческая pilot scope reference, а не текущая scope-метка release-candidate линии `v1.2.0`.
