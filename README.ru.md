...
Проект является proprietary. Все права защищены. Использование, копирование,
модификация, повторное распространение, deployment, hosting или создание
производных работ не разрешены без явного письменного разрешения.

Публичный доступ к репозиторию не предоставляет лицензию. По вопросам
коммерческого или частного лицензирования свяжитесь с владельцем. См.
[LICENSE](LICENSE).
