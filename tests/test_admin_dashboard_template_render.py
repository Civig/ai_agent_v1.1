...
class AdminDashboardTemplateRenderTests(unittest.IsolatedAsyncioTestCase):
    async def test_admin_dashboard_route_renders_expected_template_and_bootstrap(self):
        ...
        self.assertIn("Monitoring Center", html)
        self.assertIn("Operator Dashboard", html)
        self.assertIn("Обзор", html)
        self.assertIn("Ресурсы", html)
        self.assertIn("История", html)
        self.assertIn("События", html)
        self.assertIn("Состояние системы за 5 секунд", html)
        ...
        self.assertIn("Один график, который объясняет динамику", html)
        self.assertIn("Полный history view", html)
        self.assertIn("Последние события", html)
        self.assertIn('data-dashboard-tab="overview"', html)
        self.assertIn('data-dashboard-view="resources"', html)
        self.assertIn('data-trend-metric="queue_depth"', html)
        self.assertIn('id="overviewTrendChart"', html)
        self.assertIn('id="overviewRecentEventsList"', html)
        self.assertIn("Предупреждения", html)
        self.assertIn('id="kpiGrid"', html)
        self.assertIn('id="resourceTelemetryGrid"', html)
        self.assertIn('id="resourceModelList"', html)
        self.assertIn('id="historyRangeSwitcher"', html)
        self.assertIn('id="eventLogList"', html)
        self.assertIn('id="historyTimelineSlider"', html)
        self.assertIn('id="historySnapshotGrid"', html)
        self.assertIn('id="eventSeverityFilter"', html)
        ...
        self.assertIn("/api/admin/dashboard/live", html)
        self.assertIn("/api/admin/dashboard/history", html)
        self.assertIn("/api/admin/dashboard/events", html)
